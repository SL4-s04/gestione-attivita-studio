...
li *newList(li *s); //create a new void list
li *addTail(li *s, struct item n); //as keyboard, add elements in queue
void printTail(li *s, const char *priority[3], struct item n); //print all elements
li *alterElements(li *s, struct item n); //increase value on any element in queue
li *inputChar(char course[][300], char desc[][300], struct item n); //take in input 3 diff strings
li *showWeek(li *s, char c[][300], int day[], int month[], int year[], struct item n, int time); //print all progress done during the week
li *addDate(int day[], int month[], int year[], struct item n); //inserting 3 numbers that are: day, month, year by keyboard
li *showDetails(li *s, char course[][300], char desc[][300], int day[], int month[], int year[], struct item n); //prints the course, description, date and num of priority
...
li *inputChar(char course[][300], char desc[][300], struct item n) { //take in input 2 diff strings
